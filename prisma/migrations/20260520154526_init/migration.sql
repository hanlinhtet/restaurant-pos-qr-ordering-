...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'QR_PAYMENT');
...
CREATE TABLE "CashQueue" (
    ...
    CONSTRAINT "CashQueue_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "CashQueue_branchId_idx" ON "CashQueue"("branchId");
...
-- AddForeignKey
ALTER TABLE "CashQueue" ADD CONSTRAINT "CashQueue_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
